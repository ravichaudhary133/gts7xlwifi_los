...
ifneq "$(CC_VERSION_TEXT)" "ZyC clang version 21.0.0git (https://github.com/llvm/llvm-project 1b622a43c4f992e07c6d2cb278291798d8994a00)"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "ld.lld"
include/config/auto.conf: FORCE
...
ifneq "$(CLANG_FLAGS)" "--target=aarch64-linux-gnu --prefix=/home/rcj/clang/bin/aarch64-linux-gnu- --gcc-toolchain=/home/rcj/clang -Werror=unknown-warning-option  -Wno-unsequenced"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
